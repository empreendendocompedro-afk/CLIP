...
def detect_and_track_faces(video_path, clip_start, clip_end, orig_w, orig_h,
    ...
    # ── Identificar clusters de locutor (esquerda/direita) ──────
    mid = orig_w // 2

    # Só posições com rosto real detectado (não interpoladas)
    ...
    if anchor_left  is None: anchor_left  = anchor_right = mid  # fallback central
